 ...
 */
	...
	function postali_child() {
		...
		if ( is_page_template( 'front-page.php' ) || is_page('257') ) {
    ...
    function postali_acf_input_admin_footer() { ?>
        <script type="text/javascript">
        (function($) {
        ...
        args.palettes = ['#ffffff', '#000000', '#80be41', '#293c49', '#f7f6ef']
        ...
        add_action('acf/input/admin_footer', 'postali_acf_input_admin_footer');
